...
class PoolManager {
    constructor(base_token_info, quote_token_info, base_amount, quote_amount, market_id) {
        ...
        this.pool_info = {
            ...
            baseReserve: new bn_js_1.BN(base_amount).mul(new bn_js_1.BN(Math.pow(10, base_token_info.decimal))),
            quoteReserve: new bn_js_1.BN(quote_amount).mul(new bn_js_1.BN(Math.pow(10, quote_token_info.decimal))),
    ...
    initializePoolInfo(market_id) {
        ...
        this.pool_info = {
            ...
            lpDecimals: this.quote_token_info.decimal,
            quoteDecimals: this.quote_token_info.decimal,
            baseReserve: new bn_js_1.BN(this.base_amount).mul(new bn_js_1.BN(Math.pow(10, this.base_token_info.decimal))),
            quoteReserve: new bn_js_1.BN(this.quote_amount).mul(new bn_js_1.BN(Math.pow(10, this.quote_token_info.decimal))),
